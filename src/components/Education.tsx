...
export default function Education() {
    ...
    return (
        <section ref={ref} id="education" className="py-20 relative bg-noise">
            <div className="container mx-auto px-6">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">{t.education.title}</h2>
                                ...
                                <div className="md:w-1/2 pl-8 md:pl-0">
                                    ...
                                    >
                                        <div className="flex items-center gap-2 text-primary mb-2">
                                            ...
                                            <span className="text-sm font-medium">{school.school}</span>
                                        </div>
